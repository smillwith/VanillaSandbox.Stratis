...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Vehicles_CHINOOK = ["CH_147F", "CH_47F", "CUP_B_CH53E_USMC", "kyo_MH47E_HC", "kyo_MH47E_Ramp", "kyo_MH47E_base", "USAF_CV22", "B_Heli_Transport_03_unarmed_F", "B_Heli_Transport_03_F"];
	IL_Supported_Vehicles_MH9 = ["B_Heli_Light_01_F", "B_mas_mar_Heli_Light_01_F", "MELB_MH6M"];
